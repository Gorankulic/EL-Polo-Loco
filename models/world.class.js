class World {
    ...
    checkEnemyCollisions() {
        // We will use a standard for loop so we can modify the array while iterating
        for (let i = 0; i < this.level.enemies.length; i++) {
            ...
            if (this.character.isColliding(enemy)) {
                ...
                // Assuming you want to remove the enemy upon collision
                this.level.enemies.splice(i, 1);
                i--; // Decrement i to account for the removed enemy.

            }
            // If you had logic to remove enemies when there's no collision, it would go here.
            // However, it's unusual to remove enemies simply because they aren't colliding with the character.
        }
    }
